...
[**My Grade:**]{.underline} I believe my grade equivalent to course work evidenced below to be an [B.]{.underline}
...
facebook_event_checkin |>
  ...
  group_by(person_id) |>
  summarize(event_count  = sum(str_detect(date, "^201712"))) |>
...
#Lab 5, Woman who hired Jeremy Bowers section 
facebook_event_checkin |>
  left_join(person, by = join_by(person_id == id)) |>
  left_join(drivers_license, by = join_by(license_id == id)) |>
  filter(car_make == "Tesla",
